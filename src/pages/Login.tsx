  ...
  return (
    <div className="login_page">
      ...
      >
        ...
        <Input value={password} placeholder="비밀번호 입력" type="password" onChange={(v) => { setPassword(v); setError(false) }} />
        <p className="login_error" style={{ visibility: error ? 'visible' : 'hidden' }}>잘못 입력하셨습니다</p>
        <Button type="submit" className="purple_btn">로그인</Button>
      </form>
